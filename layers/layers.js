...
lyr_StudyArea_PointVillages3Projected_1.set('fieldLabels', {'Join_Count': 'header label - visible with data', 'TARGET_FID': 'inline label - visible with data', 'JOIN_FID': 'header label - visible with data', 'X': 'header label - visible with data', 'Y': 'header label - visible with data', 'Type_of_Co': 'header label - visible with data', 'Joint_Code': 'header label - visible with data', 'Date': 'header label - visible with data', 'Year': 'header label - visible with data', 'M_Kiti_Kij': 'header label - visible with data', 'TAREHE': 'header label - visible with data', 'OBJECTID': 'header label - visible with data', 'Region_Cod': 'header label - visible with data', 'Region_Nam': 'header label - visible with data', 'District_C': 'header label - visible with data', 'District_N': 'header label - visible with data', 'Ward_Code': 'header label - visible with data', 'Ward_Name': 'header label - visible with data', 'Vil_Mtaa_N': 'header label - visible with data', 'Shape_Leng': 'header label - visible with data', 'Shape_Area': 'header label - visible with data', 'Village_Co': 'header label - visible with data', 'Pop_densit': 'header label - visible with data', 'Rinfall': 'header label - visible with data', 'Rainfall': 'header label - visible with data', 'Temperatur': 'header label - visible with data', 'Popl_Denst': 'header label - visible with data', 'Recla24AG': 'header label - visible with data', 'RoadS': 'header label - visible with data', 'SerengetiB': 'header label - visible with data', 'Settlement': 'header label - visible with data', 'Riverwater': 'header label - visible with data', 'LULC': 'header label - visible with data', 'ReclLULC': 'header label - visible with data', });
